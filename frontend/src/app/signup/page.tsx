...
import { EyeIcon, EyeSlashIcon, ArrowRightIcon, UserIcon, CpuChipIcon } from '@heroicons/react/24/outline'
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // TODO: Implement actual signup with API service
        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <p className="text-blue-200">
              Create your account and unlock AI-powered coaching insights
            </p>
          </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-slate-800/50 border border-slate-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
                >
